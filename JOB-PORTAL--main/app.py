    ...
    def search_jobs(skills, location="", num_results=5, salary_range=None, date_filter="Any time", company_filter="Any size", job_type_filter="All Types", experience_level_filter="All Levels"):
        ...
        mock_jobs = [
            ...
            },
            {
                ...
                "company": "CodeCraft Solutions",
                "location": "Pune, IN",
                "description": "Internship opportunity to learn Python, web basics and data analysis. Work with mentors on internal tools and automation scripts.",
                "skills_match": ["Python", "HTML", "CSS", "JavaScript", "Pandas", "NumPy"],
                "url": "https://example.com/job11-intern",
